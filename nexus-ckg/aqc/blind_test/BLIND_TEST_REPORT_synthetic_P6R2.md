...
- intent_detected_total: 2  (detectó 1+ intents)
- intent_routed_total:   2    (exactamente 1 → ruteó)
- intent_conflict_total: 0  (>1 candidatos → fallback)
- intent_fallback_total: 8  (total − routed)
- intent_precision:      1.0        (cuando rutea, ¿acierta?)
- routing_source breakdown: {'keyword': 7, 'intent': 2, 'none': 1}
...
- **Matched keywords (top)**: ['cobre', 'no', 'todavia']
...
- **Router**:       concept=medicion framework=RT_16_HISTORIC confidence=medium source=keyword
- **Router reason**: concept_strong__framework_inferred_from_default
- **Intent**: detected=False routed=False conflict=False candidates=[]
...
- **Router**:       concept=realizacion framework=RT_16_HISTORIC confidence=medium source=keyword
