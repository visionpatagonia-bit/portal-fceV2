...
- framework_accuracy_on_routed: 0.8889
...
- **Router**:       concept=marca_generada_internamente framework=IASB confidence=medium
- **Router reason**: concept_strong__framework_inferred_from_default
- **All concepts hit**: ['marca_generada_internamente'] (num_matched=1)
...
- **Router**:       concept=devengado framework=NUA confidence=medium
...
- **Matched keywords (top)**: ['no cobre todavia', 'no cobré todavía']
...
- **Router**:       concept=medicion framework=RT_16_HISTORIC confidence=medium
- **Router reason**: concept_strong__framework_inferred_from_default
- **All concepts hit**: ['medicion'] (num_matched=1)
- **Matched keywords (top)**: ['medis', 'medís', 'como medis', 'cómo medís']
...
- **Router**:       concept=realizacion framework=NUA confidence=medium
- **Router reason**: concept_strong__framework_inferred_from_default__disambiguated_by=realizacion_over_patrimonio
- **All concepts hit**: ['patrimonio_neto', 'realizacion'] (num_matched=2)
- **Matched keywords (top)**: ['resultados no realizados']
...
- **Matched keywords (top)**: ['cobra en cuotas']
