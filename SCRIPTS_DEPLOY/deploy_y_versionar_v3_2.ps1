# =====================================================================
# deploy_y_versionar_v3_2.ps1
# v3.2 · feedback Ariel + decisiones CTO B/A/A/A/C - 2026-05-07
#
# Hace dos cosas:
...
Write-Host "=== PASO 3/3: Commit + Push v3.2 ===" -ForegroundColor Cyan
git add "NEXUS FITNES/dashboard/NEXUS_Fitness_2028_DEMO_ARIEL_v3_MOBILE_READY.html"
git add "SCRIPTS_DEPLOY/deploy_y_versionar_v3_2.ps1"
git add "SCRIPTS_DEPLOY/commit_message_v3_2.txt"
...
Write-Host ""
Write-Host "=== v3.2 COMPLETO ===" -ForegroundColor Green
Write-Host "OK Deploy + commit + push" -ForegroundColor Green
Write-Host "Lead avisar cuando este listo · NO mandar mensaje a Ariel desde aqui" -ForegroundColor Yellow
