...
git add "NEXUS FITNES/scripts/auditor_modo_ariel.js"
git add "NEXUS FITNES/scripts/backtest_vs_rutinas_ariel.js"
...
Write-Host ""
Write-Host "=== DEPLOY COMPLETO · v2028.39 Anti-fail Ariel ===" -ForegroundColor Green
Write-Host "+ Backtest 71% overlap vs 8 rutinas historicas Ariel"
Write-Host "+ Auditor modo Ariel 76% PASS (8 reglas no-negociables)"
Write-Host "+ Metricas observables UI · alerta si <50% overlap"
Write-Host "+ Comparador A/B Normal vs Ariel · 1 click"
Write-Host "+ 5 perfiles demo Ariel-tipo (Maria/Luciana/Roberto/Camila/Susana)"
Write-Host "+ Priority top-freq sort (hip thrust, patada gluteo, sillon cuadr)"
